...
//EXPLAINED JK: THE ARGUMENT IS THE ARRAY YOU INCLUDE WHEN YOU CALL THE FUNCTION. 
// - CREATE A NEW CONSTANT THAT HOSTS A SET (https://developer.mozilla.org/es/docs/Web/JavaScript/Reference/Global_Objects/Set) 
// - THAT WILL RETURN TRUE IF IT REACHES TO HOST 10 DIGITS. 
// - CREATE A STRING FOR EACH ARRAY ELEMENT, CALLED fourNumbers. 
// - SPLIT IT TO MAKE IT A UNIQUE ARRAY 
// -EXECUTE forEach METHOD TO ADD A digit (element) TO THE SET CREATED BEFORE. 
// -THEN USE AN IF STATEMENT: IF THE SIZE OF THE SET EQUALS TEN, IT WILL RETURN THE fourNumbers WHERE THE SIZE OF THE SET BECAME 10, SUCCESSFULLY FULFILLING THE EXPECTATIONS OF THE EXERCISE.
